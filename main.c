...
void help(){
    ...
    printf(Y"  -u  "B G"[имя архива]"B T4"Разархивация\n");
    printf(Y"  -ud "B G"[имя архива]"B T4"Разархивация + удаление архива\n\n");
    printf(Y"  -l  "B G"[имя архива]"B T4"Список файлов в архиве\n\n");
